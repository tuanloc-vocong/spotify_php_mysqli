    ...
    <div class="container">
        ...
        <table id="customers" align="center" border="1" style="border-color:#fff;" class="displaySinger">
            ...
            <tr>
                ...
                <td>
                    <img style="width: 50px; height: 50px;" src="<?php echo '../' . $singer['image'] ?>" alt="">
                </td>
                <td><?php echo $singer['name'] ?></td>
                <td><?php echo $singer['info'] ?></td>
                <td>
                    <a style="padding: 5px; background-color: #66FF33; color: #fff; border-radius: 15px; text-decoration: none;" href="insertSinger.php?id=<?php echo $singer['id'] ?>"><strong>Update</strong></a>
                </td>
                <td>
                    <a style="padding: 5px; background-color: #66FF33; color: #fff; border-radius: 15px; text-decoration: none;" href="deleteSinger.php?id=<?php echo $singer['id'] ?>"><strong>Delete</strong></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
        <div class="c3">
            <a href="insertSinger.php">Insert Singer</a>
        </div>
            ...
            if(this.readyState == 4 && this.status == 200){
                ...
                results.map((value, index) => {
                    html += `<tr>
                                <td>${index + 1}</td>
                                <td>
                                    <img style="width: 50px; height: 50px;" src='../${value['image']}'/>
                                </td>
                                <td>${value['name']}</td>
                                <td>${value['info']}</td>
                                <td>
