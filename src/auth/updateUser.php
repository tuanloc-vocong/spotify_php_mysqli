...
<body>
    <div class="link">
        <a href="adminDashboard.php" class="ca2"><strong>Back</strong></a>
        <a href="" style="margin-top: 5px;"></a>
    </div>
    <table align="center" border="2" style="border-color: #fff;width: 600px;line-height: 40px;color: white;">
        ...
        <?php foreach($users as $index => $user) : ?>
            <tr>
                ...
                <td><a style="padding: 5px;background-color: #E3242B;color: #fff;border-radius: 15px; text-decoration: none;" href="delete.php?<?php echo $user['id'] ?>"><strong>Delete</strong></a></td>
            </tr>
        <?php endforeach; ?>
    </table>
